...
Module.register("MMM-SmartTouch", {
    ...
    getDom: function() {
        ...
        //Youtube Button
        var main_menu_li_youtube = document.createElement("li");
        main_menu_li_youtube.innerHTML = "<span class='fa fa-youtube fa-3x'></span>" + "<br>유튜브 <hr>";
        main_menu_li_youtube.className = "li-t"
        main_menu_li_youtube.style.cursor = "pointer"
        main_menu_ul.appendChild(main_menu_li_youtube)
        main_menu_li_youtube.addEventListener("click", () => this.sendNotification("YOUTUBE", {}));
        
        //Home Training Button
        var main_menu_li_hometraining = document.createElement("li");
        main_menu_li_hometraining.innerHTML = "<span class='fa fa-dumbbell fa-3x'></span>" + "<br>홈트레이닝 <hr>";
        main_menu_li_hometraining.className = "li-t"
        main_menu_li_hometraining.style.cursor = "pointer"
        main_menu_ul.appendChild(main_menu_li_hometraining)
        main_menu_li_hometraining.addEventListener("click", () => this.sendSocketNotification("HOMETRAINING", {}));

        //Power Off Button
        var main_menu_li_shutdown = document.createElement("li");
        main_menu_li_shutdown.innerHTML = "<span class='fa fa-power-off fa-3x'></span>" + "<br>종료 <hr>";
        main_menu_li_shutdown.className = "li-t"
        main_menu_li_shutdown.style.cursor = "pointer"
        ...
        main_menu_li_restart.innerHTML = "<span class='fa fa-repeat fa-3x'></span>" + "<br>재시작";
        main_menu_li_restart.className = "li-t"
        main_menu_li_restart.style.cursor = "pointer"
